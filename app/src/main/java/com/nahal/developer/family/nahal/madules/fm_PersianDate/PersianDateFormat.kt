package com.nahal.developer.family.nahal.madules.fm_PersianDate
...
class PersianDateFormat {
    ...
    constructor()
     ...
     fun format(date: PersianDate): String {
        ...
        val values = arrayOf(
            date.shortTimeOfTheDay,
            date.dayName(),
            "" + date.shDay,
            date.monthName(),
            "" + date.shYear,
            textNumberFilter("" + date.hour),
            textNumberFilter("" + date.minute),
            textNumberFilter("" + date.second),
            textNumberFilter("" + date.shDay),
            "" + date.get12FormatHour(),
            "" + date.shMonth,
            textNumberFilter("" + date.shMonth),
            "" + date.monthDays,
            "" + date.dayOfWeek(),
            year2, "" + date.dayInYear,
            date.timeOfTheDay,
    ...
    fun parse(date: String, pattern: String = this.pattern): PersianDate {
        val JalaliDate: ArrayList<Int?> = object : ArrayList<Int?>() {
            init {
                add(0)
                add(0)
                add(0)
    ...
    companion object {
        ...
        fun format(
            ...
            val values = arrayOf(
                ...
                date.monthName(),
                "" + date.shYear,
                textNumberFilterStatic("" + date.hour),
                textNumberFilterStatic("" + date.minute),
                textNumberFilterStatic("" + date.second),
                textNumberFilterStatic("" + date.shDay),
                "" + date.get12FormatHour(),
                "" + date.shMonth,
